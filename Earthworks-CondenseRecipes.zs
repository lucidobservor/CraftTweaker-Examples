...
// Recommendation: use Dropt to change earthworks:block_chalk to drop earthworks:block_chalk 
// instead of earthworks:item_chalk. Uncomment this line if you do so.
